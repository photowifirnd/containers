...
int main(void)
{
	...
	std::vector<int> const miConst(2, 5);
	const std::vector<int>::const_iterator cit = miConst.begin();
	std::cout << "Valor del const_iterator: " << *cit << std::endl;

	/********************************/

	std::vector<int>::reverse_iterator rit = miVector.rbegin();
	std::cout << "rbegin value: " << *rit << std::endl;

	const std::vector<int>::const_reverse_iterator crit = miConst.rbegin();
	std::cout << "const rbegin value: " << *crit << std::endl;

	rit = miVector.rend();
	std::cout << "Valor de rit con rend(): " << *(--rit) << std::endl;

	const std::vector<int>::const_reverse_iterator crit2 = miConst.rend();
	std::cout << "Valor de crit2 con rend() const: " << *(crit2) << std::endl;
