...
int main(void)
{
	std::cout << "******* Constructors ********" << std::endl;
	{
		...
		ft::list<int> miLista0;
		std::cout << "\tRange constructor" << std::endl;
		ft::list<int> miLista1(5, 200);
		std::cout << "\tCopy constructor" << std::endl;
		ft::list<int> miLista2(miLista1);
		std::cout << "\tAsignation constructor" << std::endl;
		miLista0 = miLista2;
		std::cout << "\t-------" << std::endl;
		std::cout << "\t* printing values" << std::endl;
		ft::list<int>::iterator it = miLista0.begin();
	...
	std::cout << "\n******** Iterators ********" << std::endl;
	{
		...
		ft::list<int>::reverse_iterator rit = miLista1.rbegin();
	...
	std::cout << "\n******** Capacity ********" << std::endl;
	{
		...
		miLista0.push_front(8);
		miLista0.push_front(28);
		miLista0.push_front(33);
		miLista0.push_front(100);
		miLista0.push_front(209);
		it = miLista0.begin();
		if (!miLista0.empty())
		{
	...
	std::cout << "\n******** Modifiers ********" << std::endl;
	{
		ft::list<int> miLista0;
		ft::list<int> miLista1;
		ft::list<int> miLista2;
		ft::list<int>::iterator it0;
		...
		std::cout << "\t\t# pop_front() modifier: " << std::endl;
		while (!miLista1.empty())
		{
			std::cout << "\t\t\t- Poping value: " << miLista1.front() << std::endl;
			miLista1.pop_front();
		}
		...
		ft::list<int>::iterator it3 = miLista2.begin();
		it3++;	
		...
		it0 = miLista2.erase(miLista2.begin());
		while (it0 != miLista2.end())
		...
		std::cout << "\t\t\t > Begin if miLista2: " << *it0 << std::endl;
		it1 = miLista2.end();
		it1 = miLista2.erase(--it1);
		miLista2.erase(++it0, --it1);
		it0 = miLista2.begin();
		for (size_t i = 0; i < miLista2.size(); i++)
			std::cout << "\t\t\t\t- Values: " << *(it0++) << std::endl;
