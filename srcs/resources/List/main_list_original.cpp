...
int main(void)
{
	std::cout << "******* Constructors ********" << std::endl;
	{
		...
		std::list<int> miLista1(5, 200);
		std::cout << "\tCopy constructor" << std::endl;
		std::list<int> miLista2(miLista1);
		std::cout << "\tAsignation constructor" << std::endl;
		miLista0 = miLista2;
		std::cout << "\t-------" << std::endl;
		std::cout << "\t* printing values" << std::endl;
		std::list<int>::iterator it = miLista0.begin();
	...
	std::cout << "\n******** Iterators ********" << std::endl;
	{
		...
		std::list<int>::reverse_iterator rit = miLista1.rbegin();
	...
	std::cout << "\n******** Modifiers ********" << std::endl;
	{
		...
		std::list<int>::iterator it3 = miLista2.begin();
		it3++;	
